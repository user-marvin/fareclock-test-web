...
<template>
  <div class="sm:w-150 xl:w-2/5 border bg-white p-4 rounded shadow-lg relative">
    <button
      @click="handleClose"
    ...
    <div class="mt-5 xl:flex xl:flex-row xl:gap-2 xl:justify-center">
      ...
      <div v-if="selectedShift" class="w-fit">
        <button
          @click="handleDelete"
    ...
    <div class="mt-5 mx-auto gap-1 flex justify-center">
      <button
        @click="handleSave"
        class="cursor-pointer bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded transition-colors duration-150"
      >
        Save
      </button>
      <button
